        ...
        <div class="col-12 p-3 row">
            ...
            <div class="col-12 col-lg-6 p-2">
                ...
                <div class="col-12 pt-2">
                    ...
                    @elseif($advertisement->type == 'pop-bottom')
                        <span class="badge badge-info">Pop from Bottom</span>
                    @elseif($advertisement->type == 'pop-top')
                        <span class="badge badge-info">Pop from Top</span>
                    @elseif($advertisement->type == 'interstitial')
                        <span class="badge badge-info">Interstitial</span>
                    @endif
                </div>
            </div>
