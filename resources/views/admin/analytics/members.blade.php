...
<div class="col-12 p-3">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('user.analytics.show', $site->id) }}" class="btn btn-secondary">Back to Dashboard</a>
    </div>
            ...
            <table class="table table-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="POST" action="{{ route('user.analytics.remove-member', $site->id) }}" class="d-inline">
                                @csrf
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('user.analytics.invite', $site->id) }}">
                @csrf
                <div class="row">
                    <div class="col-md-8">
            ...
            <table class="table table-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="POST" action="{{ route('user.analytics.cancel-invitation', $invitation->id) }}" class="d-inline">
                                @csrf
                                @method('DELETE')
