@extends('layouts.admin', ['page_title' => 'تعديل موقع تحليلات'])
        ...
        <div class="create-site-header">
            <div class="create-site-header-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <line x1="16" y1="4" x2="22" y2="10"></line>
                </svg>
            </div>
            <h1>تعديل موقع التحليلات</h1>
            <p>قم بتعديل معلومات الموقع</p>
        </div>
        
        <form method="POST" action="{{ request()->routeIs('admin.*') ? route('admin.analytics.update', ['site' => $site->site_key]) : route('user.analytics.update', ['site' => $site->site_key]) }}">
            @csrf
            @method('PUT')
            ...
            <div class="form-actions">
                ...
                <a href="{{ request()->routeIs('admin.*') ? route('admin.analytics.show', $site->site_key) : route('user.analytics.show', $site->site_key) }}" class="btn-modern btn-modern-secondary">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
