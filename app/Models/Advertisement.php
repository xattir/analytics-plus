...
class Advertisement extends Model
{
    ...
    {
        return $this->belongsToMany(AnalyticsUrlPattern::class, 'advertisement_url_patterns');
    }
    ...
    {
        return $this->belongsToMany(AnalyticsUrlPattern::class, 'advertisement_excluded_patterns');
    }
